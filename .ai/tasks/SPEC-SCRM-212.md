# SPEC-SCRM-212: 裂变活动 FissionCampaign.vue
...
#### 产出物
apps/ops-console/src/views/fissions/FissionCampaign.vue + API composable + 路由注册

#### 内容
- 创建 FissionCampaign.vue 页面，路由: /fissions
