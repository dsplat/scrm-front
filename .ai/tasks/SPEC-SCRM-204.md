# SPEC-SCRM-204: 会员等级体系 MembershipLevel.vue
...
#### 产出物
apps/ops-console/src/views/levels/MembershipLevel.vue + API composable + 路由注册

#### 内容
- 创建 MembershipLevel.vue 页面，路由: /membership/levels
