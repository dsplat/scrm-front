# SPEC-SCRM-207: 会员卡/储值卡 MembershipCard.vue
...
#### 产出物
apps/ops-console/src/views/cards/MembershipCard.vue + API composable + 路由注册

#### 内容
- 创建 MembershipCard.vue 页面，路由: /membership/cards
