# SPEC-SCRM-201: 海报管理 PosterManagement.vue
...
#### 产出物
apps/ops-console/src/views/posters/PosterManagement.vue + API composable + 路由注册

#### 内容
- 创建 PosterManagement.vue 页面，路由: /posters
