# SPEC-SCRM-211: 优惠券管理 CouponManagement.vue
...
#### 产出物
apps/ops-console/src/views/coupons/CouponManagement.vue + API composable + 路由注册

#### 内容
- 创建 CouponManagement.vue 页面，路由: /coupons
