# SPEC-SCRM-213: 抽奖活动 LotteryCampaign.vue
...
#### 产出物
apps/ops-console/src/views/lotteries/LotteryCampaign.vue + API composable + 路由注册

#### 内容
- 创建 LotteryCampaign.vue 页面，路由: /lotteries
