# SPEC-SCRM-222: 商品管理 ProductManagement.vue
...
#### 产出物
apps/ops-console/src/views/products/ProductManagement.vue + API composable + 路由注册

#### 内容
- 创建 ProductManagement.vue 页面，路由: /products
