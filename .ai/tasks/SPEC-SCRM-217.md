# SPEC-SCRM-217: 转化漏斗分析 FunnelAnalysis.vue
...
#### 产出物
apps/ops-console/src/views/funnel/FunnelAnalysis.vue + API composable + 路由注册

#### 内容
- 创建 FunnelAnalysis.vue 页面，路由: /analytics/funnel
